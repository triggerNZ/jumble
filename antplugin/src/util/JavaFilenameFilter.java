...
/**
 * This Class is used to filter file names in a directory so that only files
 * with name ending with the specified phrase are identified. It is used
 * implicitly when </code>list()</code> method of File class is called.
 * 
 * @author Jay Huang
 */
...
public class JavaFilenameFilter implements FilenameFilter {
  ...
  public boolean accept(File dir, String filename) {
    ...
    return !filename.endsWith(this.rejectname) && filename.endsWith(this.name);
  }
}
